    ...
    <div className="App">
      <div className='sidebar'>
        ...
        <div className='lowerSide'>
          ...
          <div className='listItems'><img src={saveIcon} alt='Saved' className='listitems-img'/>Saved</div>
          <div className='listItems'><img src={rocket} alt='Upgrade' className='listitems-img'/>Upgrade to Pro</div>  
        </div>
      </div>
      <div className='main'>
        <div className='chats'>
        ...
        <div className='chatFooter'>
          ...
          <p>ChatGPT may produce inaccurate information about people, places, or facts. ChatGPT March 20 Version.</p>
        </div>
      </div>
